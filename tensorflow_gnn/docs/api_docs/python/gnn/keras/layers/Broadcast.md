...
<meta itemprop="name" content="gnn.keras.layers.Broadcast" />
...
# gnn.keras.layers.Broadcast

<!-- Insert buttons and diff -->

<table class="tfo-notebook-buttons tfo-api nocontent" align="left">
<td>
  <a target="_blank" href="https://github.com/tensorflow/gnn/tree/master/tensorflow_gnn/keras/layers/graph_ops.py#L446-L544">
...
<code>gnn.keras.layers.Broadcast(
...
the tag, node/edge_set_name, and the feature_name. The call arguments take
...
<a target="_blank" class="external" href="https://github.com/tensorflow/gnn/tree/master/tensorflow_gnn/keras/layers/graph_ops.py#L354-L359">View
source</a>
