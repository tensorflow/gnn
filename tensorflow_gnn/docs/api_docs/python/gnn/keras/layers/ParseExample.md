description: Applies tfgnn.parse_example(graph_tensor_spec, _) to a batch of
strings.

<div itemscope itemtype="http://developers.google.com/ReferenceObject">
<meta itemprop="name" content="gnn.keras.layers.ParseExample" />
...
<code>gnn.keras.layers.ParseExample(
    graph_tensor_spec: <a href="../../../gnn/GraphTensorSpec.md"><code>gnn.GraphTensorSpec</code></a>,
    **kwargs
)
</code></pre>
...
<a target="_blank" class="external" href="https://github.com/tensorflow/gnn/tree/master/tensorflow_gnn/keras/layers/parse_example.py#L19-L21">View
source</a>
