...
<meta itemprop="name" content="gnn.keras.layers.ParseSingleExample" />
...
# gnn.keras.layers.ParseSingleExample
...
<code>gnn.keras.layers.ParseSingleExample(
...
<a target="_blank" class="external" href="https://github.com/tensorflow/gnn/tree/master/tensorflow_gnn/keras/layers/parse_example.py#L35-L37">View
source</a>
