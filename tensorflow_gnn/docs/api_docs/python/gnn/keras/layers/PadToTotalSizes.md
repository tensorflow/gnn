...
<meta itemprop="name" content="gnn.keras.layers.PadToTotalSizes" />
...
# gnn.keras.layers.PadToTotalSizes
...
<code>gnn.keras.layers.PadToTotalSizes(
    sizes_constraints: <a href="../../../gnn/SizeConstraints.md"><code>gnn.SizeConstraints</code></a>,
    *,
    validate: bool = True,
    **kwargs
)
...
`sizes_constraints`, passed at initialization time. See that function for
...
<a target="_blank" class="external" href="https://github.com/tensorflow/gnn/tree/master/tensorflow_gnn/keras/layers/padding_ops.py#L42-L46">View
source</a>
...
<a target="_blank" class="external" href="https://github.com/tensorflow/gnn/tree/master/tensorflow_gnn/keras/layers/padding_ops.py#L31-L40">View
source</a>
