description: Returns an empty feature with a shape that fits the input graph
piece.

<div itemscope itemtype="http://developers.google.com/ReferenceObject">
<meta itemprop="name" content="gnn.keras.layers.MakeEmptyFeature" />
...
# gnn.keras.layers.MakeEmptyFeature

<!-- Insert buttons and diff -->

<table class="tfo-notebook-buttons tfo-api nocontent" align="left">
<td>
  <a target="_blank" href="https://github.com/tensorflow/gnn/tree/master/tensorflow_gnn/keras/layers/map_features.py#L321-L371">
...
<code>gnn.keras.layers.MakeEmptyFeature(
...
(num_items) is the number of edges, nodes or components contained in the graph
piece, and 0 is the feature dimension that makes this an empty tensor. In
particular, if graph_shape == [], meaning graph_piece is from a scalar
GraphTensor, the result is a Tensor of shape [graph_piece.total_size, 0]. That
shape is constant (for use on TPU) if graph_piece.spec.total_size is not None.
