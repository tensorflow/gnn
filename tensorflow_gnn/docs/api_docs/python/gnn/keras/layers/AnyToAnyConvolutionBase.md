...
<meta itemprop="name" content="gnn.keras.layers.AnyToAnyConvolutionBase" />
...
# gnn.keras.layers.AnyToAnyConvolutionBase

<!-- Insert buttons and diff -->

<table class="tfo-notebook-buttons tfo-api nocontent" align="left">
<td>
  <a target="_blank" href="https://github.com/tensorflow/gnn/tree/master/tensorflow_gnn/keras/layers/convolution_base.py#L14-L374">
...
<code>gnn.keras.layers.AnyToAnyConvolutionBase(
    *,
...
`tfgnn.TARGET` for (a) and `tfgnn.CONTEXT` for (b). The side input from edges
can be activated in case (1a) by setting the init arg `sender_edge_feature=`.
...
<a target="_blank" class="external" href="https://github.com/tensorflow/gnn/tree/master/tensorflow_gnn/keras/layers/convolution_base.py#L317-L374">View
source</a>
...
<a target="_blank" class="external" href="https://github.com/tensorflow/gnn/tree/master/tensorflow_gnn/keras/layers/convolution_base.py#L188-L214">View
source</a>
