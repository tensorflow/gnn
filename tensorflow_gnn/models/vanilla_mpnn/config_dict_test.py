...
from tensorflow_gnn.models.vanilla_mpnn import config_dict as vanilla_mpnn_config_dict
...
class ConfigDictTest(tf.test.TestCase):
  ...
  def test_graph_update_defaults(self):
    ...
    cfg = vanilla_mpnn_config_dict.graph_update_get_config_dict()
    cfg.units = units
    cfg.message_dim = message_dim
    cfg.receiver_tag = receiver_tag
    actual = vanilla_mpnn_config_dict.graph_update_from_config_dict(cfg)
